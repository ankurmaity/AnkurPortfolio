...
class _ExperienceCardState extends State<ExperienceCard> {
  ...
  Widget _buildHeader(bool isMobile) {
      ...
      return Column(
        ...
        children: [
          Row(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              _buildCompanyIcon(size: 48),
              const SizedBox(width: 12),
              Expanded(child: _buildCompanyDetails(isMobile: true)),
              AnimatedRotation(
    ...
    return Row(
      ...
      children: [
        ...
        Expanded(child: _buildCompanyDetails()),
        const SizedBox(width: 12),
        Column(
  ...
  Widget _buildCompanyDetails({bool isMobile = false}) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Text(
  ...
  Widget _buildCompanyIcon({double size = 58}) {
    return Container(
      width: size,
      height: size,
  ...
  Widget _buildTechnologyPreview() {
    ...
    final previewCount = technologies.length > 4 ? 4 : technologies.length;

    return Wrap(
      spacing: 8,
      runSpacing: 8,
      children: [
        ...technologies.take(previewCount).map(
              (technology) => AppChip(
                title: technology,
                color: widget.experience.color,
              ),
